...
class aws_grader():
    ...
    def validate_sqs_queues(self):
        logging.info("Starting SQS queue validation...")
        logging.info(f"Request SQS Queue Name: {self.req_sqs_name}, Response SQS Queue Name: {self.resp_sqs_name}")
        ...
        try:
            ...
            logging.info(f"SQS Request Queue:{self.req_sqs_name} has {ip_queue_requests} pending messages.")
            logging.info(f"SQS Response Queue:{self.resp_sqs_name} has {op_queue_response} pending messages.")
            ...
            logging.error(f"SQS Queues Error: {ex}. Please Check your AWS Account")

        logging.info("SQS queue validation completed.")
